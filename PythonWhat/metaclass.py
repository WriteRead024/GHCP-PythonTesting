...
class NewMetaclass(type):
    def __new__(cls, name, bases, attrs):
        ...
        def describe_what_is_happening(self):
            print("NewMetaclass is a metaclass because it is an extension of the 'type' metaclass.")
...
class MyRegularClass:
    def __init__(self):
        self.custom_attr = 'This is a reassigned custom attribute value of the MyRegularClass class.'

# Create an instance of the regular class
my_regular_obj = MyRegularClass()

# Access the custom attribute of the regular class
print(my_regular_obj.custom_attr)  # Output: This is a reassigned custom attribute value of the MyRegularClass class.